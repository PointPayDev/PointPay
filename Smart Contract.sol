...
// PXP Coin contract based on the full ERC20 Token Standard
// https://github.com/ethereum/EIPs/issues/20
// Verified Status: ERC20 Verified Token
// PXP Coin Symbol: PXP


contract PointPayToken { 
...
/**
 * PointPay Token Math opPXPtions with safety checks to avoid unnecessary conflicts
 */
...
contract PXPStandardToken is PointPayToken, Ownable {
    
    using PXPMaths for uint256;
  ...
  contract PointPay is PXPStandardToken {
    ...
    */
    ...
    string constant public name = "PointPay";
    string constant public symbol = "PXP";
